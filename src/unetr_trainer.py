...
class UNETR_TRAINER(): 
    def __init__(self, model, criterion, optimizer = None, scheduler = None,  log_dir = "./logs", device = "cpu"):
    ...
    def test(self, data_batches): 
        ...
        class_report = classification_report(y_true=total_ground_truth, y_pred=total_predicted, zero_division=0) 
